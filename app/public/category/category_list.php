...
<body>
    ...
    <div class="relative overflow-x-auto w-[35%] sm:rounded-lg mx-auto mt-9">
        ...
        <div>
            <a href="/public/category/category_create.php"
                ...
                <?php foreach (getAllCategories($mysqli) as $category): ?>
                    <tr
                        ...
                        <td class="px-6 py-4 flex">
                            <a href="category_edit.php?id=<?= $category['id'] ?>&name=<?= $category['name'] ?>" class="p-1" title="Редактировать">
                            ...
                            <a href="/includes/category/delete_category.php?id=<?= $category['id'] ?>" class="p-1"
